...
map.getView().fit([-5148383.603356, -2767060.954019, -4386400.307074, -2318682.424109], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Frentes Limpa Rio</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (236 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Esse é um mapa teste para a publicação de uma visualização das Frentes de Trabalho do Programa Limpa Rio desenvolvido pelo Instituto Estadual do Ambiente (INEA) do Estado do Rio de Janeiro.<br /><br />Confecção: SEAS/INEA/DIRRAM<br />Data: 11/07/2024<br />';
            }
